...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> Data User:: <%=application.getAttribute("uname") %></span></h2>
          <p class="infopost">&nbsp; <a href="#" class="com"></a></p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="620" height="222" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style3">
			...
			<li><a href="E_Att_req.jsp">Request Call Attributes</a></li>
			<li><a href="E_View_All_Attribute_Request_Status.jsp">View All Call Attribute Request Status</a></li>
			<li><a href="E_Find_Call_Attributes_Details.jsp">Find Call Attributes Details</a></li>
