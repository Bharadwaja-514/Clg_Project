      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="ex_menu style3"><li class="style4">
            ...
            <li class="style6"><a href="O_Upload_Datasets.jsp">Upload All Data Sets </a></li>
            <li class="style6"><a href="O_View_All_Datasets.jsp">View All Datasets </a></li>
            <li class="style6"><span class="style6"><a href="index.html"><em>Logout</em></a></span></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
